...
void BandHS::update_goodvarstack1(int flipvar)
{
  	int v;
...
void BandHS::update_goodvarstack2(int flipvar)
{
...
void BandHS::print_best_solution()
{
...
void BandHS::simple_print(char *filename)
{
  	if (best_soln_feasible != 0)
	{
		if (verify_sol() == 1){
...
inline void BandHS::unsat(int clause)
{
...
inline void BandHS::sat(int clause)
{
