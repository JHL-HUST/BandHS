...
void BandHS::build_neighbor_relation()
{
    int i, j, count;
    int v, c, n;
...
void BandHS::build_instance(char *filename)
{
    istringstream iss;
    string line;
    char tempstr1[10];
...
void BandHS::allocate_memory()
{
    ...
    selected_clauses_hard = new int[malloc_clause_length];
    selected_times = new int[malloc_clause_length];
    sampled_clauses = new int[malloc_clause_length];
    
    lit_score = new double[2*malloc_var_length];
    lit_times = new int[2*malloc_var_length];
    lit_score_hard = new double[2*malloc_var_length];
    lit_times_hard = new int[2*malloc_var_length];
    candidates = new int[2*malloc_var_length];
    clause_select_step = new int[malloc_clause_length];
    selected_lits = new int[2*malloc_var_length];
    selected_lits_hard = new int[2*malloc_var_length];
}

void BandHS::free_memory()
{
    int i;
    ...
    delete[] lit_score;
    delete[] lit_times;
    delete[] lit_score_hard;
    delete[] lit_times_hard;
    delete[] candidates;
    delete[] clause_select_step;
    delete[] selected_lits;
    delete[] selected_lits_hard;
}
